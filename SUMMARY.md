...
* [Agg\(Flight\)](api/aggflight.md)
  * [API V1](api/aggflight/api.md)
    ...
    * [flightPolling](api/aggflight/api/flightroll.md)
    * [flightVerify](api/aggflight/api/flightverify.md)
    * [flightCreateorder](api/aggflight/api/flightcreateorder.md)
    * [flightTicketing](api/aggflight/api/flightticketing.md)
    * [flightVerifyPNR](api/aggflight/api/flightverifypnr.md)
    * [flightCancelOrder](api/aggflight/api/flightcancelorder.md)
